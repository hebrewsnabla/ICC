...
# Define the specific plot commands.
def plot_calc1():
    """
...
def plot_calc2():
    ...
    en_sch.add_energy_level('Struc2', 3.3, 0)
    en_sch.add_energy_level('FC', 3.8, 0, linestyle = ':')
    en_sch.add_energy_level('TS2', 3.4, 1)
    en_sch.add_energy_level('Struc3', 2.8, 2)

    en_sch.plot_connections()
    
    en_sch.plot_energy_levels(linestyle = '-', color='blue')
