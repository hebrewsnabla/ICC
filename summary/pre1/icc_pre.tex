...
\begin{frame}
\begin{figure}
	\includegraphics[width=\linewidth]{../../1011/sample/sn2c.png}
\end{figure}
\begin{table}[H]
	\begin{tabular}{ccccc}
		\hline
...
\includegraphics[width=0.4\linewidth]{../../1011/claisen/tsb4.png}
\animategraphics[width=0.4\linewidth,loop,autoplay]{20}{../../1011/claisen/tsb4_}{0}{48}
~\\
...
\frametitle{Chair A}
\begin{figure}
	\includegraphics[width=0.8\linewidth]{../../1011/claisen/ircb4_tot_ener.png}
\end{figure}
\end{frame}
...
\begin{figure}
	\includegraphics[width=0.45\linewidth]{../../1011/claisen/Rb4.png}
	\includegraphics[width=0.45\linewidth]{../../1011/claisen/Pb4.png}
\end{figure}
\end{frame}

\begin{frame}
\begin{figure}
	\includegraphics[width=0.8\linewidth]{../../1011/claisen/cl.png}
...
\includegraphics[width=0.4\linewidth]{../../1011/claisen/ts4.png}
%\animategraphics[width=0.4\linewidth,loop,controls]{20}{../claisen/tsb4_}{0}{48}
\includegraphics[width=0.5\linewidth]{../../1011/claisen/irc4_tot_ener.png}
\end{frame}
...
\begin{figure}
	\includegraphics[width=0.4\linewidth]{../../1011/3/ts3.png}
	%\animategraphics[width=0.4\linewidth,loop,controls]{20}{../claisen/tsb4_}{0}{48}
	\includegraphics[width=0.5\linewidth]{../../1011/3/irc32_tot_ener.png}
\end{figure}
