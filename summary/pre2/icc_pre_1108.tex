...
\usepackage{mhchem}
\usepackage{animate}
\usepackage[isbn=false,doi=false,uniquename=init,url=false,style=chem-acs]{biblatex}
...
\frametitle{TS}
\begin{figure}
	\animategraphics[width=0.45\linewidth,loop,autoplay]{30}{../../1030/Pt/pbe0/vib/Pt_tsb000}{00}{47}
